...
const Testimonials: React.FC = () => {
        ...
        return (
                <div className='w-full text-center py-[2vw] '>
                        <p className='text-[2.4vw] md:text-[2vw] lg:text-[1.2vw] text-[rgba(0,0,0,0.4)] font-medium'>التوصيات</p>
                        <p className='text-[4.5vw] md:text-[4vw] lg:text-[3.5vw] font-medium'>تقييمات المستخدمين</p>
