                ...
                <div className='rounded-md w-full text-white bg-[#232323] px-[5vw] py-5 relative'>
                        ...
                        <div className='flex flex-row justify-between items-center relative  p-[1vw] rounded-full text-white z-50'>
                                        ...
                                        <div className="block md:hidden absolute top-[110%] right-0 rounded-md  bg-[#232323] p-[2vw]  w-[70vw]">
                                                ...
                                                <div className='flex md:hidden rounded-md absolute bg-[#232323] flex-col px-4 py-2 gap-2 top-[110%] right-[10vw] w-[40vw] md:w-[20vw]'>
                                                        ...
                                                        <div className='flex flex-row  items-center  justify-between '>
                                                                ...
                                                                <Link to={"/ar/become-provider"} className='text-black font-medium bg-[#9EE970] py-[0.8vh]  px-[2vw]  rounded-full'>لمزودي الخدمة</Link>
                                                        </div>
                                                </div>
                                        </div>
                                )}
                                ...
                                <div className='hidden md:flex flex-row gap-3 items-center text-[10px] sm:text-base   '>
                                        ...
                                        <Link to={"/ar/become-provider"} className='text-black font-medium bg-[#9EE970] py-4  px-5 rounded-full'>لمزودي الخدمة</Link>
                                </div>
                        ...
                        <div className='my-[4vh] w-[45%]'>
                                <p className='text-[5vw] z-10'>إنجاز خدمات ومشاكل منزلك الان على <span className='text-[rgba(255,255,255,0.5)]'>هودي</span></p>
                                <p className='font-medium  z-10 text-[rgba(255,255,255,0.4)] text-[1.7vw]'> استخدم هودي الان لنوصلك مع خبراء خدمات المنازل من حولك بضغطة زر وبالسعر اللي تختاره!</p>
                        ...
                        <div className="flex flex-row items-center w-[50%] justify-around">
                                <div>
                                        ...
                                        <p className='text-[rgba(154,161,143)] text-[1.8vw] font-medium'>عميل سعيد</p>
                                </div>
                                <div>
                                        <p className='text-[4vw] font-bold'>6+</p>
                                        <p className='text-[rgba(154,161,143)] text-[1.8vw] font-medium'>خدمات</p>
                                </div>
                                <div>
                                        <p className='text-[4vw] font-bold'>1+</p>
                                        <p className='text-[rgba(154,161,143)] text-[1.8vw] font-medium'>سنوات الخبرة</p>
                                </div>
                        </div>
                </div>
        )
