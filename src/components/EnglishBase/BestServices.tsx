        ...
        return (
                <div className='px-[5vw] py-[4vh] flex flex-col md:flex-row w-full gap-[4vw] '>
                        ...
                        <div className='w-full md:w-[50%]'>
                                ...
                                <p className='text-[2.2vw] md:text-[1.7vw] text-[rgba(0,0,0,0.4)] font-medium my-[2vh]'>Our mission is to have one-platform to connect you to the most expert service providers around you where they can compete to win your approval and to let providers offer the best price that suit you and your request.</p>
