                        ...
                        <img src="/image/phone4.png" alt=""  className='absolute  -top-[13vw] w-[45vw] right-[2vw]'/>
                                <div className="w-[100%] flex flex-row justify-between">
                                        <div className='w-[50%]'>
                                                ...
                                                <p className='font-medium text-[rgba(35,35,35,0.4)] my-[1vh] text-[2.1vw] lg:text-[1.7vw]'>Offer your services now on Hoode Provider platform and increase your revenue from people around you and services matching your expertise!</p>
