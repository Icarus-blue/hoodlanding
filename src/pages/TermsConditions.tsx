                    ...
                    <li>
                        <div className='my-1'>
                            ...
                            <ul className='my-3 list-decimal pl-5'>
                                ...
                                <li>
                                    Customers must create an account on Hoode to access certain features. By creating an account, you agree to provide accurate and up-to-date information.</li>
                                ...
                                <li>
                                    Customers must be at least 18 years old to use Hoode.</li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        <div className='my-1'>
                            ...
                            <ul className='my-3 list-decimal pl-5'>
                                ...
                                <li>
                                    We retain the authority to approve or reject the update for any reason .</li>
